...
public:
	...
	class UCapsuleComponent*                           ClashCapsuleBP;                                           // 0x1A78(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent*                    ThrownParticle;                                           // 0x1A80(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
