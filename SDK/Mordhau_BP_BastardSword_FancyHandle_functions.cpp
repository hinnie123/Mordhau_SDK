...
void UBP_BastardSword_FancyHandle_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BastardSword_FancyHandle.BP_BastardSword_FancyHandle_C.UserConstructionScript");

	UBP_BastardSword_FancyHandle_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BastardSword_FancyHandle.BP_BastardSword_FancyHandle_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BastardSword_FancyHandle.BP_BastardSword_FancyHandle_C.ReceiveActorBeginOverlap");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BastardSword_FancyHandle.BP_BastardSword_FancyHandle_C.ReceiveTick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BastardSword_FancyHandle.BP_BastardSword_FancyHandle_C.ExecuteUbergraph_BP_BastardSword_FancyHandle");
