...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MaceSkin_WardensMace.BP_MaceSkin_WardensMace_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MaceSkin_WardensMace(int EntryPoint);
};
