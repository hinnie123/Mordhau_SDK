...
public:
	...
	class UBoxComponent*                               Box;                                                      // 0x0C98(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AController*                                 PlanterController;                                        // 0x0CA0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	float                                              SafeTime;                                                 // 0x0CA8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0CAC(0x0004) MISSED OFFSET
	TArray<float>                                      DamageByArmorTier;                                        // 0x0CB0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              DamageToHorse;                                            // 0x0CC0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0CC4(0x0004) MISSED OFFSET
	class USoundCue*                                   TrapTriggerSound;                                         // 0x0CC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class AMordhauCharacter*                           PlanterCharacter;                                         // 0x0CD0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	int                                                MaxTrapsPerPlayer;                                        // 0x0CD8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0CDC(0x0004) MISSED OFFSET
	struct FName                                       PlaceableLimitName;                                       // 0x0CE0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
