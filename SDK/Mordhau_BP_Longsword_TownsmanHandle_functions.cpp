...
void UBP_Longsword_TownsmanHandle_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Longsword_TownsmanHandle.BP_Longsword_TownsmanHandle_C.UserConstructionScript");

	UBP_Longsword_TownsmanHandle_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Longsword_TownsmanHandle.BP_Longsword_TownsmanHandle_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Longsword_TownsmanHandle.BP_Longsword_TownsmanHandle_C.ReceiveActorBeginOverlap");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Longsword_TownsmanHandle.BP_Longsword_TownsmanHandle_C.ReceiveTick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Longsword_TownsmanHandle.BP_Longsword_TownsmanHandle_C.ExecuteUbergraph_BP_Longsword_TownsmanHandle");
