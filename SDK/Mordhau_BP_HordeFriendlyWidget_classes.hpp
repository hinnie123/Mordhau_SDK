...
// WidgetBlueprintGeneratedClass BP_HordeFriendlyWidget.BP_HordeFriendlyWidget_C
// 0x0010 (0x0220 - 0x0210)
class UBP_HordeFriendlyWidget_C : public UMordhauUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_HordeFriendlyWidget.BP_HordeFriendlyWidget_C");
		return ptr;
	}
