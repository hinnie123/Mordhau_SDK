...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeHUDWidget.BP_HordeHUDWidget_C.GetVisibility_3");

	UBP_HordeHUDWidget_C_GetVisibility_3_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeHUDWidget.BP_HordeHUDWidget_C.GetVisibility_2");

	UBP_HordeHUDWidget_C_GetVisibility_2_Params params;
...
struct FText UBP_HordeHUDWidget_C::Get_TextBlock_1_Text_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeHUDWidget.BP_HordeHUDWidget_C.Get_TextBlock_1_Text_1");

	UBP_HordeHUDWidget_C_Get_TextBlock_1_Text_1_Params params;
...
struct FText UBP_HordeHUDWidget_C::Get_TextBlock_3_Text_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeHUDWidget.BP_HordeHUDWidget_C.Get_TextBlock_3_Text_1");

	UBP_HordeHUDWidget_C_Get_TextBlock_3_Text_1_Params params;
...
ESlateVisibility UBP_HordeHUDWidget_C::Get_SkillPointsContainer_Visibility_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeHUDWidget.BP_HordeHUDWidget_C.Get_SkillPointsContainer_Visibility_1");

	UBP_HordeHUDWidget_C_Get_SkillPointsContainer_Visibility_1_Params params;
