...
public:
	...
	class UBP_FrontlineHUDWidget_C*                    FrontlineHUDWidget;                                       // 0x05A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
